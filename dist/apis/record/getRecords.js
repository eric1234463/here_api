...
function getRecords(req, res, next) {
  _models2.default.Record.findAll({
    ...
    }, { model: _models2.default.Patient }, { model: _models2.default.RecordFactor, include: _models2.default.Factor }, { model: _models2.default.RecordMedicine, include: _models2.default.Medicine }]
